...
final class GuardAgainstNonExistingClassString {
     ...
     * @param callable(string):\Throwable|class-string<T> $throwable the exception/error to throw in case `@see $value` is an nonexisting class-string.
     * If not specified, it defaults to `@see RuntimeException`.
     ...
     *
     * @throws RuntimeException if `@see $throwable` is not a valid class-string that subclass `@see Throwable`.
     */
