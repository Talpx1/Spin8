...
class SettingTest extends TestCase {
    ...
    public function test_setting_object_gets_instantiated(): void {
        ...
        WP_Mock::userFunction('remove_accents')->once()->with($name)->andReturn($name);
        WP_Mock::userFunction('sanitize_title_with_dashes')->once()->with($name, '', 'save')->andReturn($name);
    ...
    public function test_setting_name_gets_initialized(): void {
        ...
        WP_Mock::userFunction('remove_accents')->twice()->with($name)->andReturn($name);
    ...
    #[Test]
    public function test_setSanitizeCallback_method_throws_RuntimeException_if_function_name_passed_do_not_points_to_an_existing_function(): void {
        $name = $this->faker->slug();
        WP_Mock::userFunction('remove_accents')->once()->with($name)->andReturn($name);
        WP_Mock::userFunction('sanitize_title_with_dashes')->once()->with($name, '', 'save')->andReturn($name);
        ...
        $setting->setSanitizeCallback('strtolower');
        
        $this->expectException(RuntimeException::class);
        $setting->setSanitizeCallback('non_existing_function');
    }
